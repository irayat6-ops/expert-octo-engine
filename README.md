...
<head>
    ...
    <script src='//libtl.com/sdk.js' data-zone='10199522' data-sdk='show_10199522'></script>
...
<body>
    ...
    <script>
        // Constants
        const POINTS_PER_AD = 0.002; // প্রতি বিজ্ঞাপনে 0.002 usdt
        const MIN_WITHDRAW_TAKA = 0.12; // ন্যূনতম উত্তোলন 0.12 usdt
        const REFERRAL_BONUS = 0.1; // রেফারেল বোনাস 0.1
        ...
        function watchAd() {
            ...
            if (typeof window.show_10199522 !== 'function') {
